...
/* harmony import */ var _modules_changeModalState_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/changeModalState.js */ "./src/js/modules/changeModalState.js.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_changeModalState_js__WEBPACK_IMPORTED_MODULE_7__["default"])(modalState);
...
/***/ "./src/js/modules/changeModalState.js.js":
/*!***********************************************!*\
  !*** ./src/js/modules/changeModalState.js.js ***!
  \***********************************************/
/*! exports provided: default */
...
var changeModalState = function changeModalState(state) {
  var sizePicture = document.querySelectorAll('#size'),
...
/***/ "./src/js/modules/closeAllModal.js":
/*!*****************************************!*\
  !*** ./src/js/modules/closeAllModal.js ***!
  \*****************************************/
/*! exports provided: default */
...
var drop = function drop() {
  ...
  function unHighlight(item) {
    ...
    item.closest('.file_upload').style.background = 'inherit'; // if (item.closest('.calc_form')) {
...
var filter = function filter() {
  ...
  var showByClass = function showByClass(items, cls, trg) {
...
/* harmony import */ var _closeAllModal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./closeAllModal */ "./src/js/modules/closeAllModal.js");
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // module for check inputs with value of number
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.appendChild(textMessage); // if dataAttribute has prop(end) we append the key and value to formData
      ...
      console.log(api); // in the end step of the quiz clear modalState
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_14__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _closeAllModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./closeAllModal */ "./src/js/modules/closeAllModal.js");
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        btnPressed = true; // close all modal window

        Object(_closeAllModal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]');
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        document.body.classList.add('modal-open');
        var rightScroll = Object(_getScrollBarSize__WEBPACK_IMPORTED_MODULE_2__["default"])();
        document.body.style.marginRight = "".concat(rightScroll, "px");
      }
    }, time);
  }
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      var scrollHeightMax = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])('assets/db.json') // from json-server -> http://localhost:3000/styles
    .then(function (res) {
      return createCards(res.styles);
    }) // if from json-server need write just res withot styles
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function showSLides(n) {
    ...
    items.forEach(function (item) {
      item.classList.add('animated'); // item.classList.add('hide');
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      paused = setInterval(function () {
        plusSlide(1);
        items[slideIndex - 1].classList.add('slideOutUp}');
      }, 3000);
    } else {
      paused = setInterval(function () {
        plusSlide(1);
